          ...
          <div className="relative flex flex-col lg:flex-row gap-6">
            ...
            >
              <div className="space-y-2">
                <Label className="text-blue-700">Original Folder</Label>
                <div className="border-2 border-dashed border-blue-200 hover:border-blue-400 transition-colors rounded-lg p-8 text-center bg-gradient-to-b from-blue-50/50 to-transparent">
            ...
            >
              <div className="space-y-2">
                <Label className="text-purple-700">Modified Folder</Label>
                <div className="border-2 border-dashed border-purple-200 hover:border-purple-400 transition-colors rounded-lg p-8 text-center bg-gradient-to-b from-purple-50/50 to-transparent">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="text-center p-4 rounded-lg bg-gray-50 border border-gray-100">
                  ...
                  <div className="text-sm text-gray-700">Unchanged Files</div>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      {folderComparison.addedFiles.map((file) => (
                        <div
                          key={file}
                          className="text-sm bg-green-50 p-2 rounded border border-green-100 hover:bg-green-100 transition-colors"
                        >
                          + {file}
                        </div>
                      ))}
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      {folderComparison.removedFiles.map((file) => (
                        <div
                          key={file}
                          className="text-sm bg-red-50 p-2 rounded border border-red-100 hover:bg-red-100 transition-colors"
                        >
                          - {file}
                        </div>
                      ))}
                    ...
                    <div className="space-y-1">
                      {folderComparison.modifiedFiles.map((file) => (
                        <button
                          ...
                          className="text-sm bg-blue-50 p-2 rounded w-full text-left hover:bg-blue-100 border border-blue-100 transition-colors"
                        >
                          ~ {file}
                        </button>
                      ))}

...
const Navbar = () => {
  return (
    <nav className="border-b border-indigo-900/30 bg-space-dark/90 backdrop-blur supports-[backdrop-filter]:bg-space-dark/60 sticky top-0 z-50">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {["Features", "Use Cases", "Reviews"].map((item, index) => (
              <motion.div
                key={item}
